...
namespace SaanapayForm.Web.Data
{
    public class ApplicationDbContext : IdentityDbContext<Employee>
    {
        ...
        // what this does is to modify the SaveChangesAsync method by actually giving it dates  in baseentity before its saved
        // so it now adds dates (created or modified) n the column database assigned
